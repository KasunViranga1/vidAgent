...
import { Bot, Brain, ImageIcon, MessageSquare, Video } from "lucide-react";
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-12 h-12 rounnded-lg flex items-center mb-4 justify-center  ${feature.iconBg}`}
                  >
      ...
      <section className="py-20 bg-gray-50">
        <div className="contatiner mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-center mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${step.iconGradient} rounded-full flex items-center justify-center mx-auto mb-4 `}
                  >
